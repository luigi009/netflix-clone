    ...
    >
      ...
      <header className="flex justify-between w-full px-8 py-8">
        ...
        <div>
          ...
          <button className="items-center bg-[#e50914] text-white text-sm px-4 py-2 rounded">
            <Link href="/Login/Index">Sign In</Link>
          </button>
        </div>
      </header>
      ...
      <main className="flex flex-col items-center justify-center flex-1 sm:px-20 text-center">
        ...
        <div className="flex flex-col mt-4 sm:flex-row">
          <input
            ...
            className="bg-white p-4 min-w-[300px] sm:min-w-[400px]"
          />
          <button
            onClick={() => signIn()}
            className="flex items-center bg-[#e50914] text-white text-xl px-8 py-4 sm:px-8 sm:py-0"
          >
            Get Started
            <svg
