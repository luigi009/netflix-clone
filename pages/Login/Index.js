      ...
      <main className="flex flex-col items-center justify-center flex-1 sm:px-20 text-center">
        <div className='bg-[#0000008c] w-full p-10'>
          ...
          <div className="flex flex-col text-left w-full">
            <h1 className="text-4xl font-medium text-white max-w-lg tracking-wide">Login</h1> 
          </div>
          <div className="flex flex-col mt-4">
            <input placeholder="Email or cell phone" className="bg-[#333] rounded-md p-4 my-2" />
            <input placeholder="Password" className="bg-[#333] rounded-md p-4 my-2" />

            <button className="bg-red-600 rounded-md text-white p-4 mt-4 sm:mt-8 sm:px-8 sm:py-4 sm:min-w-[400px]">Entrar</button>
          </div>
          ...
          <div className='flex w-full flex-col my-2 sm:justify-between sm:flex-row'>
            ...
            <div className='flex flex-row justify-start items-center w-full sm:justify-end'>
              <a href="#" className="text-[#b3b3b3] hover:underline">Do you need help?</a>
            </div>
          </div>

          <div className='flex flex-row w-full'>
            <span className='text-[#b3b3b3]'>Are you new?</span>
            <a className='text-white mx-2 hover:underline' href='/'>Subscribe now</a>
          </div>
