  ...
  return (
    <>
      <div
        ...
        className="movieRow--item mobile:mr-60 sm:hidden lg:inline-block w-[250px] transition duration-[0.2s] ease-in-out transform scale-[0.9] hover:scale-[1] mobile:hidden"
      >
        <div
