...
const allItemResults = document.querySelectorAll(".movieRow--item--result") ? document.querySelectorAll(".movieRow--item--result") : 0;
let numberOfResults = []
  ...
  return (
    <>
      <div 
        ...
        className="movieRow--item--result inline-block w-[250px] transition duration-[0.2s] ease-in-out transform scale-[0.9] hover:scale-[1]">
