...
const FeaturedMovie = ({
  ...
  return (
    <>
      <section
        className="featured h-[80vh] bg-cover bg-center"
        style={{
      ...
      >
        ...
        >
          ...
          >
            <div className="featured--name text-4xl font-bold">
              {originalName}
            </div>
            <div
              className="featured--year mr-4 inline-block text-4xl max-w-[40%] font-bold"
            ...
            <div
              className="font-medium featured--description mt-4 sm:mr-3 sm:text-lg text-[#fff] sm:max-w-[40%]"
              style={{ textShadow: "2px 2px 4px rgb(0 0 0 / 45%)" }}
            >
